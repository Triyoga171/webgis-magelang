...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" name="File Geodatabase Feature Class" description="" mimeType="" type="Local Area Network" size=""/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial dimensions="2" maxy="0" crs="EPSG:4326" minx="0" minz="0" miny="0" maxx="0" maxz="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
